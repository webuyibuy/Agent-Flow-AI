      ...
      <CardContent className="pt-0">
        ...
        {task.metadata?.user_notes && (
          <div className="bg-blue-50 p-3 rounded-lg mb-4">
            <p className="text-sm text-blue-800">{task.metadata.user_notes}</p>
          </div>
        )}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700">
                      Click "I'll Work On This" to move a task to your home dashboard where you can complete it.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700">
                      Here's a history of all the dependency tasks you've completed for your agents.
                    </p>
                  </div>
                </div>
              </div>
